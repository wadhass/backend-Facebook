...
const uploadFileToCloudinary = (file) => {
  ...
  return new Promise((resolve, reject) => {
    const uploadMethod = file.mimetype.startsWith('video') ? cloudinary.uploader.upload_large : cloudinary.uploader.upload;

    uploadMethod(file.path, options, (error, result) => {
